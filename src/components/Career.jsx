...
const Career = ({ career }) => {
    ...
    return (
        <div className='w-1/2 flex gap-2 mt-8'>
            <div>
                <a href='https://linkedin.com/in/thedeepakmaurya' ><img className='w-[80px] border-white shadow-md shadow-black rounded-lg hover:grayscale' alt='thumbnail-img' src={img} /></a>
            </div>
            <div className=''>
